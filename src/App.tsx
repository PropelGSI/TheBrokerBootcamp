...
const faqs = [
...

  {
    ...
    answer:
      `The workshop fee is ${EVENT_PRICE}. Payment instructions are shown during registration. Complete the payment, upload your proof of payment, and submit the form. Your slot is confirmed once payment has been verified.`,
  },

  {
    question: 'Is registration open?',
    answer:
      'Yes. Registration is now open and slots are limited. Complete your details, make the workshop payment, upload your proof of payment, and submit your registration.',
  },
]
  ...
  return (
    <div className="site-wrap">
      ...
      <main id="main-content">
        ...
        <section
          id="workshop"
          className="workshop section-light"
        ...
        >
          <div className="shell">
            ...
            <div className="workshop-grid">
              ...
              <Reveal className="workshop-heading">
                ...
                <h2 id="workshop-title">
                  Build the reputation that arrives before you do.
                </h2>
              ...
              >
                ...
                <p className="body-lead">
                  Brand Before You Sell is a practical workshop designed
                  to help real estate professionals become more memorable,
                  more credible, and more intentional about the way they
                  build trust in today&apos;s market.
                </p>

                <p>
                  Rather than chasing attention, the workshop explores
                  how to build a reputation that attracts the right
                  clients and creates opportunities that compound over
                  time.
                </p>

                <p>
                  The workshop is intended both for people starting their
                  careers and professionals looking to take their
            ...
            <div
              className="workshop-values"
              aria-label="The workshop outcomes"
            >
              ...
              <div>
                <span>03</span>
                <strong>GROW WITH INTENT</strong>
              </div>
          ...
          <div className="shell">
            ...
            <Reveal className="speakers-heading">
              ...
              <h2 id="speakers-title">
                Practical perspective from people who teach real
                estate every day.
              </h2>
            ...
            <div className="speaker-grid">
              ...
              <Reveal>
                ...
                <article className="speaker-card">
                  ...
                  <p>
                    One of the Philippines&apos; leading real estate
                    content creators and a licensed broker, helping
                    thousands of Filipinos better understand real estate
              ...
              <Reveal delay={120}>
                ...
                <article className="speaker-card speaker-card--offset">
                  ...
                  <p>
                    A respected real estate educator known for
                    simplifying complex real estate concepts and helping
                    brokers communicate with greater clarity and
                    confidence.
                  </p>
            ...
            <div className="details-copy">
              ...
              <Reveal>
                ...
                <p className="details-note">
                  Venue details will be announced soon. Capacity is
                  limited to keep the workshop interactive and valuable
            ...
            <div className="registration-copy">
              ...
              <Reveal>
                ...
                <p className="registration-intro">
                  Complete your details, make the workshop payment,
                  and upload your proof of payment below.
                  Your slot is confirmed once payment has been verified.
                </p>
                ...
                <div className="registration-callout">
                  ...
                  <p className="registration-fee-note">
                    Payment is completed during registration.
                    Proof of payment is required before submitting.
                  </p>
          ...
          <div className="shell">
            ...
            <div className="beginning-top">
              ...
              <Reveal className="beginning-heading-block">
                ...
                <div className="beginning-copy">
                  ...
                  <p className="body-lead">
                    Brand Before You Sell is the first of many Broker
                    Bootcamp experiences designed to help raise the
                    standard of the real estate profession.
                  </p>

                  <p>
                    The community is for professionals who believe success
                    is earned through trust, integrity, and continuous
                    growth.
                  </p>
            ...
            <Reveal className="closing-quote">
              ...
              <blockquote>
                ...
                <span>
                  <mark>
                    They&apos;re built together, over time.
                  </mark>
                </span>
          ...
          <div className="shell contact-grid">
            ...
            <div className="contact-copy">
              ...
              <Reveal>
                ...
                <h2 id="contact-title">
                  Ask the Broker Bootcamp team.
                </h2>

                <p>
                  Have a question about the workshop? Send it our way and
                  we&apos;ll get back to you using the details you
                  provide.
                </p>
      ...
      <a
        ...
        href="#register"
        onClick={() =>
          track('mobile_sticky_register_click')
        }
      >
        <span>
          LIMITED SLOTS
